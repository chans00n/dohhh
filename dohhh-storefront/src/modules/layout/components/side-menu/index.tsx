            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-colors ease-out duration-200 focus:outline-none hover:bg-light-bg-hover dark:hover:bg-dark-bg-hover rounded-full p-2"
                >
                  <span className="sr-only">Open menu</span>
                  <svg
                    className="w-5 h-5 text-light-text-base dark:text-dark-text-base"
                    viewBox="0 0 24 24"
                    fill="none"
