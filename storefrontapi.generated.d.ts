...
export type ActiveCampaignQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ActiveCampaignQuery = {
  products: {
    nodes: Array<{
      campaignDeadline?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignDeadlineCustom?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignDeadlineCustomNs?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
    }>;
  };
...
export type RegularProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type RegularProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        priceRange: {
...
export type CampaignSuccessQueryVariables = StorefrontAPI.Exact<{
  productId: StorefrontAPI.Scalars['ID']['input'];
}>;

export type CampaignSuccessQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
      campaignBackers?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignBackerCount?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignTotalRaised?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignCurrentQuantity?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignGoalQuantity?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
    }
  >;
...
export type ProductWithMetafieldsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductWithMetafieldsQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
      campaignName?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignSlug?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignNameCustom?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignSlugCustom?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignNameCustomNs?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      campaignSlugCustomNs?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
    }
  >;
...
export type ProductTagsQueryVariables = StorefrontAPI.Exact<{
...
export type ProductTagsQuery = {
  node?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Product, 'id' | 'tags'>>;
};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ActiveCampaign(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: 1, query: "tag:campaign AND status:active", sortKey: CREATED_AT, reverse: true) {\n      nodes {\n        campaignDeadline: metafield(namespace: "campaign", key: "deadline") { value }\n        campaignDeadlineCustom: metafield(namespace: "custom.campaign", key: "deadline") { value }\n        campaignDeadlineCustomNs: metafield(namespace: "custom", key: "campaign_deadline") { value }\n      }\n    }\n  }\n': {
    ...
    variables: ActiveCampaignQueryVariables;
  };
  ...
  '#graphql\n  query RegularProducts ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 12, sortKey: UPDATED_AT, reverse: true, query: "NOT tag:campaign") { \n      nodes { \n        id \n        title \n        handle \n        priceRange { \n          minVariantPrice { \n            amount \n            currencyCode \n          } \n        } \n        featuredImage { \n          id \n          url \n          altText \n          width \n          height \n        } \n      } \n    }\n  }\n': {
    return: RegularProductsQuery;
    variables: RegularProductsQueryVariables;
  };
  ...
  '#graphql\n  query CampaignSuccess($productId: ID!) {\n    product(id: $productId) {\n      id\n      title\n      handle\n      campaignBackers: metafield(namespace: "campaign", key: "backers") {\n        value\n      }\n      campaignBackerCount: metafield(namespace: "campaign", key: "backer_count") {\n        value\n      }\n      campaignTotalRaised: metafield(namespace: "campaign", key: "total_raised") {\n        value\n      }\n      campaignCurrentQuantity: metafield(namespace: "campaign", key: "current_quantity") {\n        value\n      }\n      campaignGoalQuantity: metafield(namespace: "campaign", key: "goal_quantity") {\n        value\n      }\n    }\n  }\n': {
    return: CampaignSuccessQuery;
    variables: CampaignSuccessQueryVariables;
  };
  ...
  '#graphql\n  query ProductWithMetafields($handle: String!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      id\n      handle\n      title\n      # Storefront only supports identifiers or specific fields\n      campaignName: metafield(namespace: "campaign", key: "name") { value }\n      campaignSlug: metafield(namespace: "campaign", key: "slug") { value }\n      campaignNameCustom: metafield(namespace: "custom.campaign", key: "name") { value }\n      campaignSlugCustom: metafield(namespace: "custom.campaign", key: "slug") { value }\n      # custom namespace with prefixed keys\n      campaignNameCustomNs: metafield(namespace: "custom", key: "campaign_name") { value }\n      campaignSlugCustomNs: metafield(namespace: "custom", key: "campaign_slug") { value }\n    }\n  }\n': {
    return: ProductWithMetafieldsQuery;
    variables: ProductWithMetafieldsQueryVariables;
  };
  ...
  '#graphql\n  query ProductTags($id: ID!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n    node(id: $id) { ... on Product { id tags } }\n  }\n': {
    return: ProductTagsQuery;
    variables: ProductTagsQueryVariables;
  };
}
