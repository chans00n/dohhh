...
import { ArrowLeft, PencilSquare, ExternalLink } from "@medusajs/icons"
      ...
      <Tabs defaultValue="overview">
        ...
        <Tabs.Content value="overview" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <Card.Header>
                <Heading level="h3">Supporters</Heading>
              </Card.Header>
              <Card.Body>
                <div className="space-y-4">
                  <div>
            ...
            <Card>
              <Card.Header>
                <Heading level="h3">Cookie Sales</Heading>
              </Card.Header>
              <Card.Body>
                <div className="space-y-4">
                  <div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <Card.Header>
                <Heading level="h3">Campaign Duration</Heading>
              </Card.Header>
              <Card.Body>
            ...
            <Card>
              <Card.Header>
                <Heading level="h3">Last Updated</Heading>
              </Card.Header>
              <Card.Body>
                <Text size="small">
                  {stats?.last_updated
